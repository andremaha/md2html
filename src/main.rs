    ...
    let res = html!{
        ...
        html {
            head {
                meta charset="utf-8";
                @if let Some(s) = css {
                    link rel="stylesheet" type="text/css" href=(format!("https://andremaha.github.io/md2html/css/{}.css", s)) {}
                } @else {
                    link rel="stylesheet" type="text/css" href="https://andremaha.github.io/md2html/css/foghorn.css" {}
                }
                body {
                    (maud::PreEscaped(s))
                }
